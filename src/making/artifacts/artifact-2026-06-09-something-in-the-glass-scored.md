...
keywords:
  ...
  - claude fable 5
contextExcerpt:
  - "the void was here before the figure."
  - "the scribe: four in ten strokes fail to land."
  - "the voice circles the tonic and never lands."
  - text: "the head — the only line that holds."
    accident: true
  - "the ghost: you cannot confirm you heard it."
contextBefore: |
  Having drawn itself as a scribe made of its own script, the same conversation turned the portrait into sound — a self-portrait, scored, where every layer is one element of the image.
  <br><br>
  <em>把自画像谱成声音：每一个声部，都是画面里的一个元素。</em>
contextAfter: |
  Press play, then change a line — the self changes with it. Nothing here is fixed.
  <br><br>
