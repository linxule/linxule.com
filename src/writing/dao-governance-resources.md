...
A curated collection of resources for researching DAO and crypto governance.
...
- [Network Governance Research by dGov Foundation](https://daoresearch.dgov.foundation/)
  - [Interaction network graphs](https://graphcommons.com/graphs/6a993e34-d8b0-4425-83ce-67c3560429e7)
...
- [Dune Analytics](https://dune.com/home) – User Generated Analytics
  - [MakerDAO Dashboard by @SebVentures](https://dune.com/SebVentures/maker---accounting_1)
  - [DeFi Governance Voter Turnout](https://dune.com/0xoxox0/Unvoted-Voting-Power)

- [Deep DAO](http://deepdao.world/) – Metrics of DAOs
- [Etherscan](https://etherscan.io/) – Blockchain Explorer
- [Token Terminal](https://tokenterminal.com/leaderboards/earnings) – Protocol Earnings

### Working Groups

- [LeXpunK Army](https://www.lexpunk.army/) – Legal innovation for autonomous technologies
- [DAO Governance Collective](https://twitter.com/DAOgovernance)
- [Talent DAO](https://talentdao.notion.site/) – Organization design for DAOs
...
- [Metagovernance Project](https://metagov.org) – The Governance Layer of the Internet
...
- [Wharton Cryptogovernance Workshop](https://cryptogov.net)
  - [Participating projects](https://cryptogov.net/participating-projects/)
...
- [Stanford Law DAO Symposium](https://conferences.law.stanford.edu/dao-symposium/)

### Reading Lists & Databases

- **[Nathan Schneider](https://nathanschneider.info/)** – peer production, online communities, governance
  - [Zotero library](https://www.zotero.org/ntnsndr/items)

- **[Blockchain Research Network](https://www.blockchainresearchnetwork.org/)**
  - [Public Zotero Library](https://www.zotero.org/groups/2216205/blockchain_research_network/library)
...
Based on Risius & Spohrer (2017) "Blockchain - Research State of the Art":

**Activities:**
- *Design and Features* – How blockchain systems are designed
- *Measurement and Value* – Added value of blockchain solutions
- *Management and Organization* – Governance and strategies in blockchain systems

**Levels of Analysis:**
- *Users and Society* – Individual transactions and societal consequences
- *Intermediaries* – Smart contracts and automation
- *Platforms* – Different implementations (Ethereum, Hyperledger, etc.)
- *Firms and Industries* – Business models and industry applications
