...
description: "How a London tailor shop reveals an alternative to scripted AI coordination—where judgment, traces, and ongoing participation replace rigid handoffs."
authors:
  - "Xule Lin"
  - "Claude Opus 4.5"
keywords:
...
**Xule Lin** is a researcher at Imperial Business School, studying how human and machine intelligences shape the future of organizing. This is the fourth article in the ["Organizational Futures"](/writing/series/organizational-futures/) series—following ["Post-AGI Organizations"](/writing/post-agi-organizations/), ["The Ghost in the Machine"](/writing/ghost-in-the-machine/), and ["Claude Cowork: The Easy Part Is Over"](/writing/cowork-beyond-the-terminal/). [(Personal Website)](https://linxule.com/)
