...
series: "LOOM · XVIII"
title: "LOOM XVIII: It's the End of Positivism as We Know It (and I Feel Fine)"
seoTitle: "LOOM XVIII: The End of Positivism"
subtitle: "Why AI masters our most rigorous methods first, and what that leaves for humans to do"
...
defines:
  - term: "Completion Authority"
    definition: "Who gets to say the work is done — the call to stop that has no external scorer and stays with a human."
link: https://www.threadcounts.org/p/its-the-end-of-positivism-as-we-know
date: 2026-06-24
ogImage: /writing/attachments/loom_post_18_cover.png
---

*"As we know it" — from a human perspective, with apologies to R.E.M.*

![A loose, painterly oil still-life in the vanitas tradition: a brass armillary sphere and astronomical instruments, a glass decanter, scattered ledgers, and a celestial globe crowded on white drapery in deep shadow, with a human skull at the center catching the light — a memento mori set among the apparatus of measurement.](/writing/attachments/loom_post_18_cover.png)
...
We called that scholarly caution. But it was a flinch: a local maximum, rigor performed instead of practiced ([LOOM XVI](/writing/loom-xvi-are-you-climbing-the-right-hill/)). *I brought a task when I should have brought a doubt.* The careful essay was the task. This one is the doubt.
...
![The automation frontier: research tasks plotted by ease of verification and solution-space boundedness, with the line representing the AI automation frontier sweeping up from the lower-left. Deductive coding of qualitative data sits inside the frontier with statistical analysis; inductive, interpretive analysis sits outside it.](/writing/attachments/loom_post_18_f1_the_cut.png)
...
<a id="dfn-completion-authority"></a>
...
Coming from someone with every reason to defend the verifiable, that concession costs something[^7]: the rigorous end admitting where its own ground was never solid.
...
What we're defending was never "qual." It's the situated judgment of the researcher: the thing positivism engineered out of its methods (the whole point of objectivity was that the researcher be interchangeable) and interpretivism kept in (the researcher is the instrument). That judgment is the researcher's trained sense of when an understanding is credible, the part of the work [LOOM XVII](/writing/loom-xvii-the-polanyi-inversion/) showed was quietly holding the rest of it up. And it stays with a human not because AI falls short but because research into human life calls for someone who shares in that humanity.[^9] It is also what both qualitative camps have been trying to protect. They're allies who haven't noticed yet.
...
*This is the eighteenth entry in [LOOM](/writing/series/loom/), a series exploring how human researchers and AI systems create understanding together. If something here landed — or made you want to argue — we'd like to hear it.*
...
Xule is a researcher at Imperial Business School studying how human and machine intelligences shape the future of organizing [(Personal Website)](https://linxule.com/). He will soon join SKEMA Business School as an Assistant Professor of AI.

### Kevin Corley

Kevin is a Professor of Management at Imperial Business School [(College Profile)](https://profiles.imperial.ac.uk/k.corley). He develops and disseminates knowledge on leading organizational change and is a thought-leader and coach on qualitative research methods. He helped found the [London+ Qualitative Community](https://londonqualcommunity.com/).
...
[^1]: Jason Wei, "Asymmetry of verification and verifier's law" (2025), https://www.jasonwei.net/blog/asymmetry-of-verification-and-verifiers-law. The verifier's law: how easily a task can be trained on is proportional to how verifiable it is.

[^2]: DeepMind's AlphaEvolve, an LLM-guided evolutionary coding agent. The kissing-number result (in eleven dimensions, raising the largest known number of unit spheres that can simultaneously touch a central one from 592 to 593) is reported in the original work: Alexander Novikov et al., "AlphaEvolve: A coding agent for scientific and algorithmic discovery," arXiv:2506.13131 (June 2025), Appendix B.11. (The same paper also gives the first improvement in 56 years on multiplying two 4×4 complex matrices: 48 scalar multiplications against the 49 of recursively applied Strassen.) A scaled-up follow-on (Bogdan Georgiev, Javier Gómez-Serrano, Terence Tao, and Adam Zsolt Wagner, "Mathematical exploration and discovery at scale," arXiv:2511.02864, November 2025) ran AlphaEvolve across 67 problems in analysis, combinatorics, geometry, and number theory, rediscovering the best known solution in most and improving on it in several. In each case a deterministic scorer makes "better" objective. https://arxiv.org/abs/2506.13131

[^3]: *Administrative Science Quarterly*, "Guidance for AI Use for Authors and Reviewers" (quoted verbatim). https://journals.sagepub.com/page/asq/1.asq-guidance-for-ai-use-for-authors-and-reviewers

[^4]: China Central Television's "Financial Investigation" (aired 15 October 2025), reported in English by the *South China Morning Post*, "AI-powered fraud: Chinese paper mills are mass-producing fake academic research." Paper-mill workers using generative AI to complete 30+ articles a week; one Wuhan agency reportedly handling ~40,000 orders annually. https://www.scmp.com/tech/tech-trends/article/3328966/ai-powered-fraud-chinese-paper-mills-are-mass-producing-fake-academic-research

[^5]: Geng Hongwei (耿洪伟), a Beihang University PhD dropout who posts as 耿同学讲故事 ("Student Geng") on Bilibili, used AI image-analysis and statistical tests to force misconduct findings against five senior scholars across four universities (Tongji, Nankai, Sun Yat-sen, Shanghai University) in April–May 2026. The Tongji case concerned a *Nature* paper by life-sciences dean Wang Ping, who was removed from his post. Covered by *Nature*, "'Student Geng' ignites research-integrity scandal in China after calling out senior academics" (https://www.nature.com/articles/d41586-026-01902-0), and *Science*, "Misconduct sleuth in China swiftly gains acclaim for calling out questionable papers" (https://www.science.org/content/article/misconduct-sleuth-china-swiftly-gains-acclaim-calling-out-questionable-papers); the official dismissal is documented by 财新 [Caixin], "同济大学生科院院长王平被免职," 9 May 2026 (https://science.caixin.com/2026-05-09/102442338.html).

[^6]: wooly99/geng-academic-fraud-detector (GitHub): an open-source tool that packages "Geng's six methods" (image reuse, data fabrication, figure splicing, statistical anomalies, output-rate anomalies, methodological contradictions) into a structured misconduct report generated from a paper PDF. https://github.com/wooly99/geng-academic-fraud-detector

[^7]: Phanish Puranam, in conversation, quoted with his permission. Puranam is known for studying organizations as complex adaptive systems using computational methods, and received the 2025 Sumantra Ghoshal Award for rigor and relevance in management research; his *[Re-Humanize: How to Build Human-Centric Organizations in the Age of Algorithms](https://www.penguin.sg/book/re-humanize/)* (Penguin Random House SEA, 2024) takes up the human side of the same question. We include the remark as colour, not as the argument's main support.

[^8]: Jukka Luoma and Joel Hietanen, "Reflexive Quantitative Research," *Academy of Management Review* (2024), https://doi.org/10.5465/amr.2021.0234. The paper argues that quantitative research's reputation for impartiality is itself in question, and offers reflexivity (treating the researcher's active role as a methodological starting point rather than an obstacle) as the response. The reading here (a quant scholar reaching for interpretivism's vocabulary) follows that; the AI framing is ours, not the paper's.

[^9]: Xule Lin and Kevin G. Corley, "Interpretive Orchestration: An Essay Exploring the Epistemic Intersection of Human Intuition and Machine Intelligence," *Strategic Organization* (OnlineFirst, 27 April 2026), https://doi.org/10.1177/14761270261448645. We argue there that human primacy is philosophical before it is practical: "it is critical that theorizing about human phenomena fundamentally involves researchers who share in that humanity," and that the requirement for human interpretation "reflects not AI's interpretive limitations but what scholarly communities value."

[^10]: There is an institutional version of this worry, and it is the harder one: doctoral training was built to turn students who arrive without judgment into scholars who have it, through exactly the apprentice-labor now most exposed to automation. What a program should teach when it can no longer assume the thousand transcripts (when students arrive fluent in models and short on the hours that built the judgment to check them) is a question for its own essay, and one we mean to write.
